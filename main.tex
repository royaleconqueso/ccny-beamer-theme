% $Header: https://github.com/royaleconqueso/ccny-beamer/ 18 Nov 2021
...
\definecolor{ccny-purple}{HTML}{7d55c7}
\definecolor{dark-purple}{HTML}{330662}
\definecolor{grey}{HTML}{b8b8b8}

\setbeamercolor{palette primary}{bg=ccny-purple,fg=white}
...
\setbeamercolor{structure}{fg=ccny-purple} % itemize, enumerate, etc
% \setbeamercolor{section in toc}{fg=black} % TOC sections

% Override palette coloring with secondary
\setbeamercolor{subsection in head/foot}{bg=ccny-purple,fg=white} %section head right side
...
\includegraphics[height=0.8cm]{ccny-beamer-logo}
\end{textblock*}}
